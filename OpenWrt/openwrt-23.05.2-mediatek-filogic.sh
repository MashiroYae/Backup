...
make image PROFILE=xiaomi_redmi-router-ax6000-ubootmod PACKAGES=" bottom dnsmasq-full htop ip-full iw-full luci luci-ssl-openssl nano-full openssh-sftp-server wget-ssl wpad-openssl -dnsmasq -libustream-mbedtls -odhcp6c -odhcpd-ipv6only -ppp -ppp-mod-pppoe -uclient-fetch -wpad-basic-mbedtls"
