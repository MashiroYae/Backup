...
cd /Users/mashiro/Library/Caches/mashiro/x86_64
if [ -f "/Users/mashiro/Library/Caches/mashiro/x86_64/linux60-$RC-x86_64.pkg.tar.zst" ]
  then
      echo 'NyaNya'
  else
      rm /Users/mashiro/Library/Caches/mashiro/x86_64/linux60-*-x86_64.pkg.tar.zst
      curl -JLO https://mirrors.manjaro.org/repo/unstable/core/x86_64/linux60-$RC-x86_64.pkg.tar.zst
fi
